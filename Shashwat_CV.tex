...
\begin{itemize}
    ...
    \item Lead a team of 5 engineers to build a \textbf{Reinforcement Learning} bidding agent for a \textbf{Battery Energy Storage System} that beat the existing linear-programming approach by 34\%. Was responsible for the technical deliverables, project-management, and system architecture.
