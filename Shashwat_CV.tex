...
\begin{itemize}
    ...
    \item Lead a team of 5 engineers to build a \textbf{Reinforcement Learning} bidding agent for a Battery Energy Storage System that the existing linear-programming approach by 34\%. As the tech lead I was responsible for the technical deliverables, project-management, and system architecture.
