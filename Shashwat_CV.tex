...
\begin{itemize}
    \item Individually built a distributed optimiser for a turbine OCM. Optimiser directly lead to +0.4% turbine efficiency (validated by CFD), in 1/20th the time, and half the cost. Optimiser used both \textbf{genetic and bayesian methods} and ran on a cluster of 20 machines using \textbf{Ray}. 
