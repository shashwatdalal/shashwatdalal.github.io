...
\begin{center}
    \runsubsection{   
    \hspace{2.25cm}Imperial College London, Computing MEng       
    \newline 
    President, Imperial College Data Science Society} 
\end{center}
...
\end{description}
%------------------------------------------------
\runsubsection{ABB Robotics}
\descript{| Robotics Intern}
\location{June 2015 – August 2015 | Tokyo, Japan}
%------------------------------------------------
% Education
%------------------------------------------------
...
\section{Education}
    ...
    \descript{| Computing MEng (Fourth Year Student with a Provisional 1st)}
    \location{2016 - 2020 | London, United Kingdom}
    \begin{description}
        \item[Academic Projects] \hspace{7.5cm}
            \begin{itemize}
                \item Beginning my final year project on \textbf{Federated Learning}.
